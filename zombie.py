...
class Zombie:
  ...
  def fight(self):
      """
      generate strength to fight zombie.
      """
  ...
  def encounter(self):
    ...
    3. You don't outrun zombie, you fight then still become a zombie whether you win or not.
    """
    outrun = self.chase()
  ...
  def increase_plague_level(cls):  
      ...
      """ 
      Zombie.plague_level = Zombie.plague_level +  random.randint(0,2)
